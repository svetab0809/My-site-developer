...
После этого готовый проект будет автоматически собираться при каждом изменении исходников.
...
Стили каждого отдельного элемента страницы пишутся в соответствующем файле. Например, в файле `src/less/header.less`,
...
### Изображения
Изображения хранятся в директории `/img`.